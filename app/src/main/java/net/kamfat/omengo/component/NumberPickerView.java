 ...
 * 网上copy的类, 源码地址 :https://github.com/Carbs0126/NumberPickerView.git
 */
...
public class NumberPickerView extends View {
    ...
    private static final int DEFAULT_TEXT_SIZE_SELECTED_SP = 18;
    ...
    // default items' vertical padding, top padding and bottom padding are both 3dp,
    // only used in wrap_content mode
    private static final int DEFAULT_ITEM_PADDING_DP_V = 3;
...
//    private int mMaxValue = 0;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mShowCount = a.getInt(R.styleable.NumberPickerView_npv_ShowCount, DEFAULT_SHOW_COUNT);
        mDividerColor = a.getColor(R.styleable.NumberPickerView_npv_DividerColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        mDividerHeight = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_DividerHeight, DEFAULT_DIVIDER_HEIGHT);
        mDividerMarginL = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_DividerMarginLeft, DEFAULT_DIVIDER_MARGIN_HORIZONTAL);
        mDividerMarginR = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_DividerMarginRight, DEFAULT_DIVIDER_MARGIN_HORIZONTAL);
        mDisplayedValues = convertCharSequenceArrayToStringArray(a.getTextArray(R.styleable.NumberPickerView_npv_TextArray));
        mTextColorNormal = a.getColor(R.styleable.NumberPickerView_npv_TextColorNormal, DEFAULT_TEXT_COLOR_NORMAL);
        mTextColorSelected = a.getColor(R.styleable.NumberPickerView_npv_TextColorSelected, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        mTextColorHint = a.getColor(R.styleable.NumberPickerView_npv_TextColorHint, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        mTextSizeNormal = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_TextSizeNormal, sp2px(context, DEFAULT_TEXT_SIZE_NORMAL_SP));
        mTextSizeSelected = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_TextSizeSelected, sp2px(context, DEFAULT_TEXT_SIZE_SELECTED_SP));
        mTextSizeHint = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_TextSizeHint, sp2px(context, DEFAULT_TEXT_SIZE_HINT_SP));
        mMinShowIndex = a.getInteger(R.styleable.NumberPickerView_npv_MinValue, 0);
        mMaxShowIndex = a.getInteger(R.styleable.NumberPickerView_npv_MaxValue, 0);
        mWrapSelectorWheel = a.getBoolean(R.styleable.NumberPickerView_npv_WrapSelectorWheel, DEFAULT_WRAP_SELECTOR_WHEEL);
        mShowDivider = a.getBoolean(R.styleable.NumberPickerView_npv_ShowDivider, DEFAULT_SHOW_DIVIDER);
        mHintText = a.getString(R.styleable.NumberPickerView_npv_HintText);
        mAlterHint = a.getString(R.styleable.NumberPickerView_npv_AlternativeHint);
        mEmptyItemHint = a.getString(R.styleable.NumberPickerView_npv_EmptyItemHint);
        mMarginStartOfHint = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_MarginStartOfHint, dp2px(context, DEFAULT_MARGIN_START_OF_HINT_DP));
        mMarginEndOfHint = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_MarginEndOfHint, dp2px(context, DEFAULT_MARGIN_END_OF_HINT_DP));
        mItemPaddingVertical = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_ItemPaddingVertical, dp2px(context, DEFAULT_ITEM_PADDING_DP_V));
        mItemPaddingHorizontal = a.getDimensionPixelSize(R.styleable.NumberPickerView_npv_ItemPaddingHorizontal, dp2px(context, DEFAULT_ITEM_PADDING_DP_H));
        mAlterTextArrayWithMeasureHint = a.getTextArray(R.styleable.NumberPickerView_npv_AlternativeTextArrayWithMeasureHint);
        mAlterTextArrayWithoutMeasureHint = a.getTextArray(R.styleable.NumberPickerView_npv_AlternativeTextArrayWithoutMeasureHint);
        mRespondChangeOnDetach = a.getBoolean(R.styleable.NumberPickerView_npv_RespondChangeOnDetached, DEFAULT_RESPOND_CHANGE_ON_DETACH);
        mRespondChangeInMainThread = a.getBoolean(R.styleable.NumberPickerView_npv_RespondChangeInMainThread, DEFAULT_RESPOND_CHANGE_IN_MAIN_THREAD);
        mTextEllipsize = a.getString(R.styleable.NumberPickerView_npv_TextEllipsize);
        a.recycle();
    }
