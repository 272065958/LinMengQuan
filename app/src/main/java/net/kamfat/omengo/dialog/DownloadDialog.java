...
import net.kamfat.omengo.http.ProgressResponseListener;
...
public class DownloadDialog extends BaseDialog implements View.OnClickListener {
    ...
    private void startDownload() {
            ...
            public boolean handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case DOWNLOAD_SUCCESS:
                        closeDialog();
                        File saveFile = new File(Tools.getTempPath(getContext()), "omengo.apk");
                        if (saveFile.exists()) {
                            saveFile.delete();
                        }
        ...
        tempFile = new File(Tools.getTempPath(getContext()), "omengo.temp");
        if (tempFile.exists()) {
            tempFile.delete();
        }
