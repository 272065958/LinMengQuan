...
public abstract class BaseTreeActivity extends BaseActivity  implements TabLayout.OnTabSelectedListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        }, currentIntent.getIntExtra("title", -1));
        initView();
    }
    ...
    private void initView() {
        ...
        listView.setDividerHeight(getResources().getDimensionPixelOffset(R.dimen.view_space));
    ...
    private void showExitDialog() {
        if (exitDialog == null) {
            ...
            exitDialog.setText(R.string.tip_title, R.string.exit_tip, R.string.button_sure, R.string.button_cancel).setTipComfirmListener(new TipDialog.ComfirmListener() {
                @Override
                public void comfirm() {
                    exitDialog.dismiss();
                    finish();
