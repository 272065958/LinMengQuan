package net.kamfat.omengo.component.tablayout;
...
//        void onTabReselected(Tab tab);
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorBottom = res.getDimensionPixelOffset(R.dimen.small_space);
    }
...
//                            .inflate(android.support.design.R.layout.design_layout_tab_icon, this, false);
                    ...
                    rlp.addRule(RelativeLayout.RIGHT_OF, R.id.tip_title);
                    rlp.addRule(RelativeLayout.ALIGN_TOP, R.id.tip_title);
